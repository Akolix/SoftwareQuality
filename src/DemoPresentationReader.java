...
/**
 * DemoPresentationReader creates a built-in demo presentation.
 * Implements only PresentationReader (read-only by design).
 * No longer violates Liskov Substitution Principle.
 *
...
public class DemoPresentationReader implements PresentationReader {
    ...
    @Override
    public void load(Presentation presentation, String unusedSource) throws IOException {
